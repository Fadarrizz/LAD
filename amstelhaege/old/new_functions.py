...
def Overlap(x, y, xMIN, xMAX, yMIN, yMAX):
...
# def FreespaceOverlap(a, x, y):
#
#     for b in buildingsPlaced:
#
#         if ((x + a.width + a.mtr_clearance) > b.x)
#         and (b.x - b.mtr_clearance < x + a.width + a.mtr_clearance):
#             return True
#         if (x - a.mtr_clearance) < (b.x + b.width)
#         and (b.x + b.width + b.mtr_clearance > x - a.mtr_clearance):
#             return True
#         if ((y + a.length + a.mtr_clearance) > b.y)
#         and (b.y + b.mtr_clearance < y + a.length + a.mtr_clearance):
#             return True
#         if (y - a.mtr_clearance) < (b.y + b.length)
#         and (b.y + b.length + b.mtr_clearance > y - a.mtr_clearance):
#             return True
#
#     return False
